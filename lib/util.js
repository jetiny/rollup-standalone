...
const {minify} = require('uglify-es/tools/index.js')
...
export default ({re, json, resolve, commonjs, rollup, babel, vue}) => {
  ...
  function createPlugins ({patterns, babelOptions, uglifyOptions, vueOptions, resolveOptions, commonjsOptions}, ongenerate) {
